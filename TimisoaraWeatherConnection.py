...
UrlToCheck = "https://api.openweathermap.org/data/2.5/weather?lat=45.75&lon=21.23&units=metric&appid=GetYourAPIKey" #the URL for Timisoara complete with my API key
