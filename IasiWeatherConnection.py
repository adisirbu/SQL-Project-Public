...
UrlToCheck = "https://api.openweathermap.org/data/2.5/weather?lat=47.17&lon=27.60&units=metric&appid=GetYourAPIKey" #the URL for Iasi complete with my API key
