...
UrlToCheck = "https://api.openweathermap.org/data/2.5/weather?lat=43.80&lon=28.58&units=metric&appid=GetYourAPIKey" #the URL for Constanta complete with my API key
